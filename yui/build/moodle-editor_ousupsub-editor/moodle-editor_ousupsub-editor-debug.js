...
/**
 * A notify function for the ousupsub editor.
 *
 * @module     moodle-editor_ousupsub-notify
 * @submodule  notify
 * @package    editor_ousupsub
...
var LOGNAME_NOTIFY = 'moodle-editor_ousupsub-editor-notify',
    NOTIFY_INFO = 'info',
...
EditorNotify.prototype = {
    ...
    /**
     * Show a notification in a floaty overlay somewhere in the ousupsub editor text area.
     *
     * @method showMessage
    ...
    showMessage: function(message, type, timeout) {
        ...
        if (this.messageOverlay === null) {
            this.messageOverlay = Y.Node.create('<div class="editor_ousupsub_notification"></div>');
        ...
        // Convert class to ousupsub_info (for example).
        type = 'ousupsub_' + type;
        ...
        this.hideTimer = Y.later(intTimeout, this, function() {
            Y.log('Hide ousupsub notification.', 'debug', LOGNAME_NOTIFY);
            this.hideTimer = null;
            this.messageOverlay.hide(true);
        });
...
Y.Base.mix(Y.M.editor_ousupsub.Editor, [EditorNotify]);
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
/**
 * Filepicker options for the ousupsub editor.
 *
 * See {{#crossLink "M.editor_ousupsub.Editor"}}{{/crossLink}} for details.
 *
 * @namespace M.editor_ousupsub
...
Y.Base.mix(Y.M.editor_ousupsub.Editor, [EditorFilepicker]);
